...
import { ClickTrackingDirective } from '../../../../directives/click-tracking/click-tracking.directive';
    ...
    this.newModalComponent = createComponent(ModalComponent, {
      ...
      directives: [
        ...
        },
        {
          ...
          bindings: [
            inputBinding('customEvent', () => 'Tracking From Modal Service'),
            outputBinding('trackingEvent', (event: unknown) => {
              console.log('Tracking Event From Listener Service ...', {
                custom: event,
              });
            }),
          ],
